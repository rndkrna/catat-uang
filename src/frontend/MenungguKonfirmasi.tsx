        ...
        >
          ...
          <div className="bg-orange-50 rounded-2xl p-4 mb-8 text-left flex items-start gap-3 border border-orange-100">
            ...
            <div>
              ...
              <button 
                onClick={() => window.open('https://wa.me/083844575235?text=Halo%20Admin,%20saya%20sudah%20melakukan%20pembayaran%20untuk%20berlangganan.%20Tolong%20dicek%20ya!', '_blank')}
